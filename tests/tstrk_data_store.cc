...
static const char *tst_dens_rk =
    R"ORNL_format( //C 1 , C 2     , A1            , B1            , A2            , B2            , A3           , B3           , T min        , T max        , Reference
    ...
    { "MSTDBTP": {
          "S1": {
              "1": {
                  ...
                  "heat_capacity": { "range": [ 0.0, 0.0 ], "reference": "ref1", "uncertainty": 0.015, "uncertainty_notes": "None", "values": [ 65.0, 0.0, 0.0, 0.0 ] },
                  "thermal_conductivity": { "range": [ 500.0, 1000.0 ], "reference": "ref1", "uncertainty": 0.2, "uncertainty_notes": "None", "values": [ 1.8, -0.00039 ] },
                  "melt": { "reference": "ref1", "abs_uncertainty": 0.01, "uncertainty_notes": "None", "value": 500.0, "value_notes": "None" },
                  "viscosity": { "range": [ 500.0, 1000.0 ], "reference": "ref1", "uncertainty": 0.01, "uncertainty_notes": "None", "values": [ 0.5, 2405.4471008988544 ] },
                  "density": { "range": [ 500.0, 1000.0 ], "reference": "ref1", "uncertainty": 0.01, "uncertainty_notes": "None", "values": [ 1.0, 0.002, 0.01 ] }
              }
          },
          "S1-S2": {
              "0.36-0.64": {
                  "boil": { "reference": "ref2", "abs_uncertainty": 0.0, "uncertainty_notes": "None", "value": 1000.0, "value_notes": "None" },
                  "heat_capacity": { "range": [ 0.0, 0.0 ], "reference": "ref2", "uncertainty": 0.001, "uncertainty_notes": "None", "values": [ 68.0, 0.0, 0.0, 0.0 ] },
                  "thermal_conductivity": { "range": [ 600.0, 900.0 ], "reference": "ref2", "uncertainty": 0.2, "uncertainty_notes": "None", "values": [ 1.2, -0.00028 ] },
                  "melt": { "reference": "ref2", "abs_uncertainty": 0.005, "uncertainty_notes": "None", "value": 500.0, "value_notes": "None" },
                  "viscosity": { "range": [ 800.0, 1000.0 ], "reference": "ref2", "uncertainty": 0.01, "uncertainty_notes": "None", "values": [ 1.25, 2405.4471008988544 ] },
                  "density": { "range": [ 500.0, 750.0 ], "reference": "ref2", "uncertainty": 0.002, "uncertainty_notes": "None", "values": [ 2.0, -0.002, 0.002 ] }
              }
    }}})test_data";
...
TEST(rk_data_store, load) {
  ...
  ASSERT_TRUE(
      tp_dflt.setComposition({"LiF", "NaF", "KF"}, {0.465, 0.115, 0.42}));
