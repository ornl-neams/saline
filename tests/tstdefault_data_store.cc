...
//Pure Salts
//System      , id , Mol Mass , Mol Frac             , Melt(K) , Var(%) , Reference   , Boil(K) , Var(%) , Reference      , rho_a     , rho_b     , range(K)      , Var(%) , Reference     , mu1_a     , mu2_b     , mu2_a      , mu2_b      , mu2_c     , range(K)      , Var(%) , Reference    , k_a        , k_b        , range(K)     , Var(%) , Reference   , cp_a      , cp_b       , cp_c       , cp_d      , Var(%) , Reference, st_a, st_b, range(K), Var(%), Reference
  ...
  static const char *scrap = R"test_data(
    { "MSTDBTP": {
        "evaluated" : {
            "S1": {
                "1": {
                    "boil": { "reference": "ref1", "pct_uncertainty": 0.0, "uncertainty_notes": "None", "value": 1000.0, "value_notes": "None" },
                    "cp": { "range": [ 0.0, 0.0 ], "reference": "ref1", "pct_uncertainty": 1.5, "uncertainty_notes": "None", "values": [ 65.0, 0.0, 0.0, 0.0 ] },
                    "k": { "range": [ 500.0, 1000.0 ], "reference": "ref1", "pct_uncertainty": 20.0, "uncertainty_notes": "None", "values": [ 1.8, -0.00039 ] },
                    "melt": { "reference": "ref1", "pct_uncertainty": 1.0, "uncertainty_notes": "None", "value": 500.0, "value_notes": "None" },
                    "mu": { "range": [ 500.0, 1000.0 ], "reference": "ref1", "pct_uncertainty": 1.0, "uncertainty_notes": "None", "values": [ 0.5, 2.0E+04 ] },
                    "rho": { "range": [ 500.0, 1000.0 ], "reference": "ref1", "pct_uncertainty": 1.0, "uncertainty_notes": "None", "values": [ 1.0, 0.002 ] },
                    "sigma": { "range": [ 500.0, 1000.0 ], "reference": "ref1", "pct_uncertainty": 1.0, "uncertainty_notes": "None", "values": [ 1.0, 0.002 ] }
                }
            },
            "S1-S2": {
                "0.36-0.64": {
                    "boil": { "reference": "ref2", "pct_uncertainty": 0.0, "uncertainty_notes": "None", "value": 1000.0, "value_notes": "None" },
                    "cp": { "range": [ 0.0, 0.0 ], "reference": "ref2", "pct_uncertainty": 0.1, "uncertainty_notes": "None", "values": [ 68.0, 0.0, 0.0, 0.0 ] },
                    "k": { "range": [ 600.0, 900.0 ], "reference": "ref2", "pct_uncertainty": 0.2, "uncertainty_notes": "None", "values": [ 1.2, -0.00028 ] },
                    "melt": { "reference": "ref2", "pct_uncertainty": 0.5, "uncertainty_notes": "None", "value": 500.0, "value_notes": "None" },
                    "mu": { "range": [ 800.0, 1000.0 ], "reference": "ref2", "pct_uncertainty": 1.0, "uncertainty_notes": "None", "values": [ 1.25, 2.0E+04 ] },
                    "rho": { "range": [ 500.0, 750.0 ], "reference": "ref2", "pct_uncertainty": 0.2, "uncertainty_notes": "None", "values": [ 2.0, -0.002 ] },
                    "sigma": { "range": [ 500.0, 750.0 ], "reference": "ref2", "pct_uncertainty": 0.2, "uncertainty_notes": "None", "values": [ 2.0, -0.004 ] }
                }
    }}}})test_data";
...
TEST(default_data_store, load_testData_literal) {
  ...
  static const char *scrap = R"test_data(
    ...
    S1   ,1,1.0,Pure Salt,500.00,1.00,ref1,1000.00,0.0,ref1,1.0, 0.002,500-1000,1.00,ref1,0.50,2.0E+04,0.0,0.0,0.0,500-1000,1.00,ref1,1.8E+00,-3.9E-04,500-1000,20.00,ref1,6.5E+01,0.0,0.0,0.0,1.50,ref1,1.0, 0.002,500-1000,1.00,ref1
    S1-S2,2,2.0,0.36-0.64,500.00,0.50,ref2,1000.00,0.0,ref2,2.0,-0.002,500-750 ,0.20,ref2,1.25,2.0E+04,0.0,0.0,0.0,800-1000,1.00,ref2,1.2E+00,-2.8E-04,600-900 ,20.00,ref2,6.8E+01,0.0,0.0,0.0,0.10,ref2,2.0,-0.002,500-750 ,0.20,ref2
    )test_data";
...
TEST(default_data_store, load_testData_binary) {
  ...
  static const char *scrap = R"test_data(
    ...
    S1-S2   ,2,2.0,0.36-0.64     ,500.00,0.50,ref2,1000.00,0.0,ref2,2.0,-0.002,500-750 ,0.20,ref2,1.25,2.0E+04,0.0,0.0,0.0,800-1000,1.00,ref2,1.2E+00,-2.8E-04,600-900 ,20.00,ref2,6.8E+01,0.0,0.0,0.0,0.10,ref1,----,----,----,----,----
    S1-S2   ,3,2.0,0.64-0.36     ,550.00,0.50,ref2,1500.00,0.0,ref2,3.0,-0.004,500-750 ,0.20,ref2,3.25,2.0E+04,0.0,0.0,0.0,800-1000,1.00,ref2,2.2E+00,-2.5E-04,600-900 ,20.00,ref2,6.8E+01,0.0,0.0,0.0,0.10,ref1,----,----,----,----,----
    S1-S2   ,4,2.0,0.50-0.50     ,600.00,0.50,ref2,2000.00,0.0,ref2,4.0,-0.006,500-750 ,0.20,ref2,2.25,2.0E+04,0.0,0.0,0.0,800-1000,1.00,ref2,1.7E+00,-1.2E-04,600-900 ,20.00,ref2,6.8E+01,0.0,0.0,0.0,0.10,ref1,----,----,----,----,----
    S1-S2-S3,5,4.0,0.23-0.50-0.27,131.20,0.50,ref3,1771.00,0.0,ref3,1.5, 0.002,100-400 ,1.00,ref3,1.68,2.3E+04,0.0,0.0,0.0,141-1327,2.00,ref3,8.5E-01,-2.4E-04,129-1800,20.00,ref3,7.6E+01,0.0,0.0,0.0,1.00,ref1,----,----,----,----,----
    )test_data";
